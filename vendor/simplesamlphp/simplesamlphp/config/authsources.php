...
$config = [
    ...
    'default-sp' => [
        ...
        'entityID' => 'http://localhost/recognition/vendor/simplesamlphp/simplesamlphp/www/module.php/saml/sp/metadata.php/default-sp',

        // The entity ID of the IdP this SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
        'idp' => 'http://www.okta.com/exk1brsu7xu76cn0v357',
