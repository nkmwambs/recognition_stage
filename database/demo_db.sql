...
('3398694590127785760095069eecaee39e402f9b',	'::1',	1527711878,	'__ci_last_regenerate|i:1527711878;user_login|s:1:\"1\";login_user_id|s:1:\"1\";name|s:9:\"Nicodemus\";login_type|s:15:\"Program Trainer\";profile_id|s:1:\"7\";country_id|s:2:\"25\";view_type|s:7:\"Surveys\";'),
...
(1,	'Program Trainer',	1,	1),
(2,	'Program Support Specialist',	1,	1),
(3,	'Partnership Facilitator',	1,	2),
(4,	'Manager Of Training',	2,	1),
...
CREATE TABLE `tabulate` (
  ...
  `nominated_user` int(100) NOT NULL,
  `created_date` datetime NOT NULL,
  `created_by` int(100) NOT NULL,
  `last_modified_by` int(100) NOT NULL,
  `last_modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `user` (`user_id`, `firstname`, `lastname`, `email`, `password`, `gender`, `phone`, `role_id`, `profile_id`, `manager_id`, `auth`, `country_id`) VALUES
(1,	'Nicodemus',	'Karisa Mwambire',	'NKarisa@ke.ci.org',	'956d2d5467ed373328ee2d165a51c399',	'male',	'254711808071',	1,	7,	2,	1,	25),
