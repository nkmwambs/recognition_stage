...
$config = [
    ...
    'default-sp' => [
        ...
        'entityID' => 'http://localhost/recognition/saml2/www/module.php/saml/sp/metadata.php/default-sp',


        // The entity ID of the IdP this SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
        'idp' => 'http://www.okta.com/exk1b8ukudcDfFoh7357',
    ...
    // 'example-sql' => [
    //     'sqlauth:SQL',
    //     'dsn' => 'mysql:host=localhost;port=3306;dbname=saml',
    //     'username' => 'compatl8_root',
    //     'password' => '@Compassion123',
    //     'query' => 'SELECT username FROM users WHERE username = :username AND AES_DECRYPT(password,"!Lov3J3sus2019") = :password',
    // ],
